...
if ((process.env.NODE_ENV || '').trim() === 'production') {
    config.authorizeGroup = cfgProduction.authorizeGroup;
    ...
    config.sqltxt = cfgProduction.sqltxt;
    config.oracleConnectionProperties = cfgProduction.oracleConnectionProperties;
} else {
    config.authorizeGroup = 'DEVELOPER\\ArchiveScanView';
    ...
    config.sqltxt = 'select * from test';
}
